...
- Complete the form only using their keyboard (nope)
...
- [getcssscan](https://getcssscan.com/css-box-shadow-examples) - i used this website when i want to copypaste a shadow style
